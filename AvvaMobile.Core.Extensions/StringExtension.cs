...
namespace AvvaMobile.Core.Extensions
{
    public static class StringExtension
    {
        ...
        public static string PrepareCDNUrl(this string imageUrl, string folder, string cdnBaseUrl)
        {
            ...
            return string.Format("{0}{1}{2}", cdnBaseUrl, folder, imageUrl);
        }

        public static string PrepareS3Url(this string imageUrl, string bucketName, string s3CDNBaseUrl)
        {
            if (string.IsNullOrEmpty(imageUrl))
            {
                return imageUrl;
            }
            return string.Format(s3CDNBaseUrl, bucketName, imageUrl);
